...
{
    internal class TaskRequestUpdateItemWrapper : IOutlookItem
    {
        private readonly Outlook.TaskRequestUpdateItem _innerObject;

        public Type InnerObjectType => typeof(Outlook.TaskRequestUpdateItem);
        public string Id => "";
        ...
        public TaskRequestUpdateItemWrapper(Outlook.TaskRequestUpdateItem item)
        {
