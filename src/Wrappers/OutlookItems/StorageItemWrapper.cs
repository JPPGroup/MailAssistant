...
{
    internal class StorageItemWrapper : IOutlookItem
    {
        private readonly Outlook.StorageItem _innerObject;

        public Type InnerObjectType => typeof(Outlook.StorageItem);
        public string Id => "";
        ...
        public StorageItemWrapper(Outlook.StorageItem item)
        {
