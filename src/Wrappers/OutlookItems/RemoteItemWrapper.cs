...
{
    internal class RemoteItemWrapper : IOutlookItem
    {
        private readonly Outlook.RemoteItem _innerObject;

        public Type InnerObjectType => typeof(Outlook.RemoteItem);
        public string Id => "";
        ...
        public RemoteItemWrapper(Outlook.RemoteItem item)
        {
