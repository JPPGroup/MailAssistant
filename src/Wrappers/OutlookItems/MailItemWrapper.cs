...
{
    internal class MailItemWrapper : IMoveable
    {
        private readonly Outlook.MailItem _innerObject;

        public Type InnerObjectType => typeof(Outlook.MailItem);
        ...
        public MailItemWrapper (Outlook.MailItem item)
        {
