...
{
    internal class JournalItemWrapper : IOutlookItem
    {
        private readonly Outlook.JournalItem _innerObject;

        public Type InnerObjectType => typeof(Outlook.JournalItem);
        public string Id => "";
        ...
        public JournalItemWrapper(Outlook.JournalItem item)
        {
