...
{
    internal class DocumentItemWrapper : IOutlookItem
    {
        private readonly Outlook.DocumentItem _innerObject;

        public Type InnerObjectType => typeof(Outlook.DocumentItem);
        public string Id => "";
        ...
        public DocumentItemWrapper(Outlook.DocumentItem item)
        {
