...
{
    internal class TaskItemWrapper : IOutlookItem
    {
        private readonly Outlook.TaskItem _innerObject;

        public Type InnerObjectType => typeof(Outlook.TaskItem);
        public string Id => "";
        ...
        public TaskItemWrapper(Outlook.TaskItem item)
        {
