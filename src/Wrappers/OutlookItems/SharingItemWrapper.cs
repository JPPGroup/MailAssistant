...
{
    internal class SharingItemWrapper : IOutlookItem
    {
        private readonly Outlook.SharingItem _innerObject;

        public Type InnerObjectType => typeof(Outlook.SharingItem);
        public string Id => "";
        ...
        public SharingItemWrapper(Outlook.SharingItem item)
        {
